...
export class Valid extends Component {
    ...
    handleRegister=(e)=>{e.preventDefault();this.setState({onsubmitted:true})
        ...
        if(this.state.pass === this.state.con)
      ...
      <div className='w-50 mt-5 ms-5 p-3 border border-3 border-dark'>
             <form className='row'>
              ...
              <div className='col-6'>
                  ...
                  <input type='password' onChange={this.handlepass} className='form-control' placeholder='Enter the password'></input>
                 
              </div>
              <div className='col-6'>
                  <label>Confirm Password</label>
                  <input type='password'    onChange={this.handlecon} className='form-control' placeholder='Enter the Confirm password'></input>
